...
\Year{2020}
  ...
  \City{Москва}
  \AuthorText{Автор}
  \Author{Медведев Иван Владимирович}
  \AuthorEng{}
  \AcadGroup{428}
  % Если вы не Пупкин Василий Иванович, то скопируйте себе этот проект через меню и уже потом правьте
  \TitleTop{Дедупликация и нормализация метаданных}
  %\TitleMiddle{}
  \TitleBottom{научных статей} % leave empty if you don't need it
  \TitleTopEng{Entity resolution and normalization of metadata of scientific articles}
  ...
  \Advisor{Недумов Ярослав Ростиславович}  
